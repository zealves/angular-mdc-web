...
var SnackbarDemoComponent = function () {
    function SnackbarDemoComponent() {
        ...
        this.isDismissOnAction = true;
        this.messageText = "Sample text";
        this.actionText = "Ok";
    }
    ...
    _createClass(SnackbarDemoComponent, [{
        ...
        value: function show() {
            this.snack.show({
                ...
                actionHandler: this.actionText ? function () {
